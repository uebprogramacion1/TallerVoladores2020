...
public class InterfazGUI extends JFrame {
	...
	public InterfazGUI(Controlador control) {
		...
		panelEntrada.getButAve().addActionListener(control);
		panelEntrada.getButhecop().addActionListener(control);
		panelEntrada.getButSuperm().addActionListener(control);
		panelEntrada.getButHidro().addActionListener(control);
